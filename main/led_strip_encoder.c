...
//    uint8_t *p1=p+1;
//    uint8_t *p2=p1+1;
    //apend_log(1, "Encode %d %d %d %d %d",*p,*p1,*p2,led_encoder->state,data_size);
...
esp_err_t rmt_new_led_strip_encoder(const led_strip_encoder_config_t *config, rmt_encoder_handle_t *ret_encoder)
{
    ...
    uint32_t reset_ticks = config->resolution / 1000000 * 250 / 2; // reset code duration defaults to 50us
