...
void mqtt_client_task(void *pvParameters) {
    ...
    while (1) {
        // Очікуємо на умовні "пакети" з MQTT (в майбутньому - web/push/sub тощо)
        // Тут можна викликати певні MQTT-запити чи перевірку стану
        // або обробляти локальні черги/запити, якщо буде потрібно

        // Імітація періодичної дії кожну секунду
        chk_mqtt_onesec();
